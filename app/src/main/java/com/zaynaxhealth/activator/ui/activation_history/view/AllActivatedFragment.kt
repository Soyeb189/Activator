...
import com.zaynaxhealth.activator.databinding.FragmentAllActivatedBinding
...
const val ALL = "Activated"

class AllActivatedFragment :  Fragment(), ClickListener<HistoryResponseModel>,
    TransactionNumber.RefreshActivatedHistory  {

    private lateinit var binding : FragmentAllActivatedBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentAllActivatedBinding.inflate(layoutInflater,container,false)
        return binding.root
    }
    ...
    fun loadData() {
        viewModel = ViewModelProvider(
            ...
            ActivatedHistoryViewModelFactory(
                sharedPreference().getString(TOKEN)!!, ALL, "", ""
            )
    ...
    private fun initAdapter(startDate: String, endDate: String) {
        val adapter = ActivatedHistoryAdapter(this, ALL)
        ...
        lifecycleScope.launch {
            viewModel.getActivatedHistory(
                sharedPreference().getString(TOKEN)!!, ALL, startDate, endDate
            ).collectLatest {
    ...
    private fun showDateRangePicker() {
        ...
        dateRangePicker.addOnPositiveButtonClickListener {
            ...
            viewModel = ViewModelProvider(
                this,
                ActivatedHistoryViewModelFactory(
                    sharedPreference().getString(TOKEN)!!, ALL, fromDate, toDate
                )
            )[ActivatedHistoryViewModel::class.java]
